...
import { faEraser, faPaintBrush, faSquare } from '@fortawesome/free-solid-svg-icons'
...
export default function Toolbar({ className = null }: Props) {
    ...
    styles.static =
        'grid grid-cols-2 grid-rows-2 md:grid-cols-[max-content_1fr_max-content] md:grid-rows-1 gap-2 md:gap-3 lg:gap-4 p-2 md:p-3 lg:p-4 bg-neutral-300'
        ...
        <Component id='Toolbar'>
            ...
            >
                <div className='flex justify-start items-center gap-2 md:gap-3 lg:gap-4 w-full col-start-1 col-span-1 row-start-1 row-span-1 md:col-start-1 md:col-span-1 md:row-start-1 md:row-span-1'>
                    ...
                    <FontAwesomeIcon
                        icon={faEraser}
                        className={`text-sm ${!game.state.isTurn ? 'pointer-events-none' : ''} ${
                    ...
                    <FontAwesomeIcon
                        icon={faEraser}
                        className={`text-md ${!game.state.isTurn ? 'pointer-events-none' : ''} ${
                    ...
                    <FontAwesomeIcon
                        icon={faEraser}
                        className={`text-lg ${!game.state.isTurn ? 'pointer-events-none' : ''} ${
                    ...
                    <FontAwesomeIcon
                        icon={faEraser}
                        className={`text-xl ${!game.state.isTurn ? 'pointer-events-none' : ''} ${
                ...
                <div className='flex justify-end items-center gap-2 md:gap-3 lg:gap-4 w-full col-start-2 col-span-1 row-start-1 row-span-1 md:col-start-3 md:col-span-1 md:row-start-1 md:row-span-1'>
                    <FontAwesomeIcon
                        icon={faPaintBrush}
                        className={`text-xs ${!game.state.isTurn ? 'pointer-events-none' : ''} ${
                            artboard.state.lineWidth === 3 ? 'text-neutral-900' : 'text-neutral-400'
                        }`}
                    ...
                    <FontAwesomeIcon
                        icon={faPaintBrush}
                        className={`text-sm ${!game.state.isTurn ? 'pointer-events-none' : ''} ${
                            artboard.state.lineWidth === 5 ? 'text-neutral-900' : 'text-neutral-400'
                        }`}
                    ...
                    <FontAwesomeIcon
                        icon={faPaintBrush}
                        className={`text-md ${!game.state.isTurn ? 'pointer-events-none' : ''} ${
                            artboard.state.lineWidth === 8 ? 'text-neutral-900' : 'text-neutral-400'
                        }`}
