...
styles.static =
    'flex justify-center items-center gap-2 md:gap-3 lg:gap-4 p-2 md:p-3 lg:p-4 bg-neutral-300 rounded-b'
        ...
        <Component id='Taskbar'>
            ...
            >
                <button
                    className={
                        game.state.isTurn
                            ? 'p-2 md:p-3 lg:p-4 w-full h-full bg-violet-500 md:bg-violet-500 hover:bg-violet-600 text-xs text-white text-center rounded'
                            : 'hidden'
                    }
