      ...
      <div className={`${styles.static} ${styles.dynamic}`}>
        <div className="h-full w-full object-cover object-center rounded overflow-clip">
          <AgoraVideoPlayer
            ...
            className="w-full h-full rounded scale-105"
          />
        </div>

        <div className="absolute inset-0 flex justify-start items-end">
          <div
            className={`w-full p-2 flex justify-between items-center rounded-b ${
          ...
          >
            ...
            >
              <FontAwesomeIcon
                icon={video.state.microphone ? faMicrophoneSlash : faMicrophone}
            ...
            >
              <FontAwesomeIcon
                icon={video.state.camera ? faVideoSlash : faVideoCamera}
                className="text-xs text-inherit"
              />
            </button>
          </div>
