  ...
  return (
    <Component id="Dashboard">
      <div className="w-full h-full flex flex-col fixed inset-0">
        ...
        <div id="view" className="h-full w-full overflow-hidden flex flex-row" x-data="{ sidenav: true }">
          <div id="sidebar" className="bg-white h-full md:block shadow-xl px-3 2xl:w-1/5 md:w-60 lg:w-60 overflow-x-hidden transition-transform duration-300 ease-in-out" x-show="sidenav">
            <div className="space-y-6 md:space-y-10 mt-10">
              ...
              <div id="menu" className="flex flex-col space-y-2">
                <Link to="new" className="group text-sm font-medium text-gray-700 py-2 px-2 hover:bg-violet-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out">
                  <FontAwesomeIcon icon={faPlusSquare} className="h-5 w-5 fill-current text-gray-600 group-hover:text-violet-500 group-hover:text-white" />
